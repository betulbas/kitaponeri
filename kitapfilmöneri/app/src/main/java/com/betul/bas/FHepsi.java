 ...
 * Use the {@link FHepsi#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FHepsi extends Fragment {
     ...
     * @return A new instance of fragment FHepsi.
     */
    // TODO: Rename and change types and number of parameters
    public static FHepsi newInstance(String param1, String param2) {
        FHepsi fragment = new FHepsi();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_f_hepsi, container, false);
        ...
        try{
            ...
            Cursor cr = database.query("Select * from OnerilerTablosu");
            while (cr.moveToNext()) {
    ...
    OneriAdapter.DeleteUpdate deleteUpdate = new OneriAdapter.DeleteUpdate() {
        ...
        public void delUpdate(int id, String turu, String ismi, String yayinYili, String sayfaSayisi, String imdbPuani, String not) {
            oneriSilGuncelle o = new oneriSilGuncelle(getActivity(),id,turu,ismi,yayinYili,sayfaSayisi, imdbPuani,not);
            o.show();
        }
    };
