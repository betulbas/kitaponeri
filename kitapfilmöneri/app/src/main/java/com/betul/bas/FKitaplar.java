 ...
 * Use the {@link FKitaplar#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FKitaplar extends Fragment {
     ...
     * @return A new instance of fragment FKitaplar.
     */
    // TODO: Rename and change types and number of parameters
    public static FKitaplar newInstance(String param1, String param2) {
        FKitaplar fragment = new FKitaplar();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_f_kitaplar, container, false);
        ...
        try{
            ...
            Cursor cr = database.query("Select * from OnerilerTablosu where Turu='Kitap'");
            while (cr.moveToNext()) {
    ...
    OneriAdapter.DeleteUpdate deleteUpdate = new OneriAdapter.DeleteUpdate() {
        ...
        public void delUpdate(int id, String turu, String ismi, String yayinYili, String sayfaSayisi, String imdbPuani, String not) {
            FKitaplar.oneriSilGuncelle o = new FKitaplar.oneriSilGuncelle(getActivity(),id,turu,ismi,yayinYili,sayfaSayisi, imdbPuani,not);
            o.show();
        }
    };
