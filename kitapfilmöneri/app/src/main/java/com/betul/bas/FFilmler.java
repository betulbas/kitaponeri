 ...
 * Use the {@link FFilmler#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FFilmler extends Fragment {
     ...
     * @return A new instance of fragment FFilmler.
     */
    // TODO: Rename and change types and number of parameters
    public static FFilmler newInstance(String param1, String param2) {
        FFilmler fragment = new FFilmler();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_f_filmler, container, false);
        ...
        try{
            ...
            Cursor cr = database.query("Select * from OnerilerTablosu where Turu='Film'");
            while (cr.moveToNext()) {
    ...
    OneriAdapter.DeleteUpdate deleteUpdate = new OneriAdapter.DeleteUpdate() {
        ...
        public void delUpdate(int id, String turu, String ismi, String yayinYili, String sayfaSayisi, String imdbPuani, String not) {
            FFilmler.oneriSilGuncelle o = new FFilmler.oneriSilGuncelle(getActivity(),id,turu,ismi,yayinYili,sayfaSayisi, imdbPuani,not);
            o.show();
        }
    };
